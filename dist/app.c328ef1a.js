...
var navContainer = document.querySelector('.navigation__list');
var navItems = document.querySelectorAll('.navigation__item');
var navLinks = document.querySelectorAll('.navigation__link');
var btnMenu = document.querySelector('.btn-toggle');
var btnExplore = document.querySelector('.btn-explore');
navContainer.addEventListener('click', clickHoverNav);

function clickHoverNav(e) {
  var clicked = e.target.closest('.navigation__item');
  console.log(clicked);
...
btnMenu.addEventListener('click', function () {
  var visual = nav.getAttribute('data-visual');
